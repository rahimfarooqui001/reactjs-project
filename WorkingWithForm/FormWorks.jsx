...
export const FormWorks = () => {
  ...
  return (
    ...
    <input type="email" className='form-control w-50 mt-4' placeholder='Enter Email'  name='email' value={email}
    onChange={handleEmail}  required  />
    <input type="password" className='form-control w-50 mt-4' placeholder='Enter Password'  name='password' value={password}
